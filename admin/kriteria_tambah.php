<div id="content">
		<!-- Page title -->
			<div class="page-title">
				<h5><i class="fa fa-bar-chart-o"></i> Halaman Tambah Kriteria</h5>
			</div>

			<!-- /page title -->

			<!-- Right labels -->
			<form class="form-horizontal" action="?spk=Kriteria_Tambah" method="post" role="form">
...
if (isset($_POST['simpan'])) {
	...
	echo "<script>window.alert('Kriteria berhasil ditambah');
			window.location=(href='?spk=Kriteria')</script>";
	}}
?>
