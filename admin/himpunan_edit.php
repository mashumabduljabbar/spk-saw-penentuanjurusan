		...
		<!-- Page title -->
			<div class="page-title">
				<h5><i class="fa fa-bookmark"></i> Halaman Edit Himpunan</h5>
			</div>
			...
			?>
			<!-- Right labels -->
			<form class="form-horizontal" action="?spk=Himpunan_Edit" method="post" role="form">
			...
			if (isset($_POST['ubah'])) {
				...
				echo "<script>window.alert('Himpunan berhasil diubah');
						window.location=(href='?spk=Himpunan')</script>";
				}}
			?>