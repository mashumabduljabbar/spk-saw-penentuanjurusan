...
<head>
	...
	<title>SPK Penentuan Jurusan Metode SAW</title>
	<meta charset="utf-8">
...
<!-- Body -->
		<div id="header">
			<div id="companyname" align="left">SMK Negeri 1 Minas</div>
			<!-- Link Menu -->
			<div align="right" class="links_menu" id="menu">
				<a href="?spk=Home"><i class="fa fa-home"></i> Home</a> | 
				<a href="?spk=Siswa"><i class="fa fa-users"></i> Calon Siswa</a> | 
				<a href="?spk=Kriteria"><i class="fa fa-bar-chart-o"></i> Kriteria</a> | 
				<a href="?spk=Himpunan"><i class="fa fa-bookmark"></i> Himpunan Kriteria</a> | 
				<a href="?spk=Klasifikasi"><i class="fa fa-tag"></i> Klasifikasi</a> | 
				<a href="?spk=Analisa"><i class="fa fa-pencil"></i> Analisa</a>
			 </div>
		</div>
	<br />